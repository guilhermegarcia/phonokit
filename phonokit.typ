...
`0.5.8` - Under-the-hood changes; updated dependenies \
...
Finally, you may have noticed that the function automatically detects Greek letters, so if you add "sigma", it will render as #sigma.#footnote[#logo also provides a list of the most common Greek letters used in phonology, which will always render without italics. See @sec-greek.]
