...
#let version = text(size: 0.8em)[`v 0.5.10`]
...
#grid(
  ...
  [#link("https://doi.org/10.5281/zenodo.17971031")[#image("extras/zenodo-badge.svg", height: 1em)]
...
#grid(
  ...
  [
    #figure(
      caption: [Code to create @fig-multi-refs],
      supplement: "Code",
      kind: "code",
      ```typst
      #multi-tier(
          ...
          levels: (
            ...
            ("", [#smallcaps("con")\(straints) #h(1em)$arrow$], "", [#smallcaps("eval")\(uation)], "", "", ""),
            ("", "", "", [* [output] *], "", "", ""),
          ),
          links: (
            ((1, 3), "p-lis2"),
  ...
  [
    #align(center)[
      #figure(
        caption: [Illustration of #ipa("/p@lis/") #a-r #ipa("[p \\r lis]") classical OT],
      )[
        #multi-tier(
          show-refs: true,
          levels: (
